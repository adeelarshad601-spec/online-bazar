...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER', 'PAYMENT', 'PRODUCT', 'SELLER', 'SYSTEM');
...
-- CreateIndex
CREATE INDEX "VendorOrder_shopId_idx" ON "VendorOrder"("shopId");
...
-- CreateIndex
CREATE UNIQUE INDEX "SellerPayout_transactionId_key" ON "SellerPayout"("transactionId");
...
-- AddForeignKey
ALTER TABLE "SellerSubscription" ADD CONSTRAINT "SellerSubscription_planId_fkey" FOREIGN KEY ("planId") REFERENCES "SellerPlan"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
